...
NAME      = "NOSHIP_AGPL__yoloe__moge2__sonnet5"
QUESTION  = "Does YOLOE deliver real-time open vocabulary AND masks? AGPL - comparison only."
SHIPPABLE = False        # False -> evaluation only. See ALERT_DO_NOT_SHIP.md

# ---- models -------------------------------------------------------------
DETECTOR  = "yoloe"        # finds and names objects
