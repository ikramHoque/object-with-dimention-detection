# Pipeline · NOSHIP_AGPL__yoloe__moge2__sonnet5

Does YOLOE deliver real-time open vocabulary AND masks? AGPL - comparison only.
...
jupyter lab poc/pipelines/NOSHIP_AGPL__yoloe__moge2__sonnet5/notebook.ipynb
```
