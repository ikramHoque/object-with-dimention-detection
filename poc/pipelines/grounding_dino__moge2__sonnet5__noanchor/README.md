# Pipeline · grounding_dino__moge2__sonnet5__noanchor

THE KEY EXPERIMENT. How much does the door anchor actually buy?
...
jupyter lab poc/pipelines/grounding_dino__moge2__sonnet5__noanchor/notebook.ipynb
```
