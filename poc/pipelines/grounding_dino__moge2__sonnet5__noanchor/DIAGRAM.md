# grounding_dino__moge2__sonnet5__noanchor — system design
...
**The question this pipeline answers:** THE KEY EXPERIMENT. How much does the door anchor actually buy?
...
| scale anchor | **DISABLED** — this run is the ablation | — |
...
flowchart TD
    ...
    S4["<b>Stage 4 · Anchor DISABLED</b><br/>scale = 1.0<br/><i>this run is the ablation</i>"]
...
| 4 | **Scale anchor** `door_scale()` | boxes + depth | **nothing — disabled in this run** | This run deliberately turns the anchor OFF, so its result minus the baseline is exactly what the anchor is worth. |
