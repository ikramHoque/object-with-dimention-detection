...
NAME      = "grounding_dino__moge2__sonnet5__noanchor"
QUESTION  = "THE KEY EXPERIMENT. How much does the door anchor actually buy?"
...
NO_ANCHOR  = True       # True disables the door scale correction (an ablation)
