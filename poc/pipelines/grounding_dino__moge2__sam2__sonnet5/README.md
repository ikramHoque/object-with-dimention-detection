# Pipeline · grounding_dino__moge2__sam2__sonnet5

Does bolting SAM 2 masks onto a box detector match a native mask model?
...
jupyter lab poc/pipelines/grounding_dino__moge2__sam2__sonnet5/notebook.ipynb
```
