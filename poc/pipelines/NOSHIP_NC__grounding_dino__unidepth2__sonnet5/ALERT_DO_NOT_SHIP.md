...
**NOSHIP_NC__grounding_dino__unidepth2__sonnet5**

This pipeline depends on `unidepth2`, which **cannot be shipped**:

- **unidepth2** — CC BY-NC 4.0
...
Measuring what staying licence-clean costs us. If `NOSHIP_NC__grounding_dino__unidepth2__sonnet5` scores materially better
