# Pipeline · NOSHIP_NC__grounding_dino__unidepth2__sonnet5

CEILING CHECK. How much accuracy does staying licence-clean cost us? CC BY-NC - cannot ship.
...
jupyter lab poc/pipelines/NOSHIP_NC__grounding_dino__unidepth2__sonnet5/notebook.ipynb
```
