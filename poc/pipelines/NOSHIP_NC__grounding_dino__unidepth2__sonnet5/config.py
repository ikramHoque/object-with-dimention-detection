...
NAME      = "NOSHIP_NC__grounding_dino__unidepth2__sonnet5"
QUESTION  = "CEILING CHECK. How much accuracy does staying licence-clean cost us? CC BY-NC - cannot ship."
SHIPPABLE = False        # False -> evaluation only. See ALERT_DO_NOT_SHIP.md

# ---- models -------------------------------------------------------------
DETECTOR  = "grounding_dino"        # finds and names objects
DEPTH     = "unidepth2"        # metres per pixel
