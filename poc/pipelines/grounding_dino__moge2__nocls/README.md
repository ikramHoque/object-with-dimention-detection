# Pipeline · grounding_dino__moge2__nocls

How does pure geometry do with no language model at all?
...
jupyter lab poc/pipelines/grounding_dino__moge2__nocls/notebook.ipynb
```
