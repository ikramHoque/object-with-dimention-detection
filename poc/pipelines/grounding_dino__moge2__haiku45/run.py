"""
FILE PURPOSE
    CLI entry point for the grounding_dino__moge2__haiku45 pipeline.
...
HOW TO RUN
    ...
    Output goes to     poc/pipelines/grounding_dino__moge2__haiku45/results/
...
from poc.pipelines.grounding_dino__moge2__haiku45 import config                # noqa: E402
