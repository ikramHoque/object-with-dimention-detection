...
NAME      = "rtdetr__da3_metric__sonnet5"
QUESTION  = "Can a licence-clean fixed-vocabulary detector plus the newest metric depth model match the open-vocabulary stack?"
SHIPPABLE = True        # False -> evaluation only. See ALERT_DO_NOT_SHIP.md

# ---- models -------------------------------------------------------------
DETECTOR  = "rtdetr"        # finds and names objects
