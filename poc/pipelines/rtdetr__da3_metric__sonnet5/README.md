# Pipeline · rtdetr__da3_metric__sonnet5

Can a licence-clean fixed-vocabulary detector plus the newest metric depth model match the open-vocabulary stack?
...
jupyter lab poc/pipelines/rtdetr__da3_metric__sonnet5/notebook.ipynb
```
