# rtdetr__da3_metric__sonnet5 — system design
...
**The question this pipeline answers:** Can a licence-clean fixed-vocabulary detector plus the newest metric depth model match the open-vocabulary stack?
