"""
FILE PURPOSE
    CLI entry point for the det_rtdetr pipeline.

HOW TO RUN
    python -m poc.pipelines.det_rtdetr.run --input my_room.jpg
    python -m poc.pipelines.det_rtdetr.run                     # if data/input has one thing
    python -m poc.pipelines.det_rtdetr.run --input my_room.jpg --box-th 0.20

    Input comes from   poc/pipelines/det_rtdetr/data/input/
    Output goes to     poc/pipelines/det_rtdetr/results/
...
from poc.pipelines.det_rtdetr import config                # noqa: E402
