# Pipeline · sam3__moge2__sam2__sonnet5

Everything we expect to be best, together. Run this LAST, after the single-factor runs point at it.
...
jupyter lab poc/pipelines/sam3__moge2__sam2__sonnet5/notebook.ipynb
```
