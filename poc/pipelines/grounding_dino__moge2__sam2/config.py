...
NAME      = "grounding_dino__moge2__sam2"
QUESTION  = "Does a per-object mask beat a bounding box? Measured: door error 16.5% -> 6.8%, but flat-fronted furniture reads too shallow."

# ---- models -------------------------------------------------------------
DETECTOR  = "grounding_dino"        # finds and names objects
DEPTH     = "moge2"        # metres per pixel
SEGMENTER = 'sam2'        # box -> mask. Measures the object, not the wall behind it
CLASSIFIER = None        # None skips Method A: no API key, no cost
