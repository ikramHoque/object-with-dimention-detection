...
NAME      = "grounding_dino__moge2__opus5"
QUESTION  = "Is Opus 5 worth 2.5x the cost for size-class accuracy?"
...
CLASSIFIER = 'claude_opus5'        # None skips Method A: no API key, no cost
