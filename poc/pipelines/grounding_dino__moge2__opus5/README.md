# Pipeline · grounding_dino__moge2__opus5

Is Opus 5 worth 2.5x the cost for size-class accuracy?
...
jupyter lab poc/pipelines/grounding_dino__moge2__opus5/notebook.ipynb
```
