# Pipeline · grounding_dino__da3_metric__sonnet5

Does Depth Anything 3's metric variant beat MoGe-2 on our footage?
...
jupyter lab poc/pipelines/grounding_dino__da3_metric__sonnet5/notebook.ipynb
```
