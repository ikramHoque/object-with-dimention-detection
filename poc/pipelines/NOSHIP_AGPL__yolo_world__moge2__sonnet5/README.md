# Pipeline · NOSHIP_AGPL__yolo_world__moge2__sonnet5

Is YOLO-World's 20x speed advantage free, or does accuracy drop? AGPL - comparison only.
...
jupyter lab poc/pipelines/NOSHIP_AGPL__yolo_world__moge2__sonnet5/notebook.ipynb
```
