...
NAME      = "NOSHIP_AGPL__yolo_world__moge2__sonnet5"
QUESTION  = "Is YOLO-World's 20x speed advantage free, or does accuracy drop? AGPL - comparison only."
SHIPPABLE = False        # False -> evaluation only. See ALERT_DO_NOT_SHIP.md

# ---- models -------------------------------------------------------------
DETECTOR  = "yolo_world"        # finds and names objects
