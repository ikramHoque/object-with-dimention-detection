...
**NOSHIP_AGPL__det_yolo_world**

This pipeline depends on `yolo_world`, which **cannot be shipped**:
...
Measuring what staying licence-clean costs us. If `NOSHIP_AGPL__det_yolo_world` scores materially better
